...
map.getView().fit([654629.973048, 9233623.516943, 658017.694200, 9235808.529060], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sistema de Agua Zaña</h2>';
        return titleElement;
    })(),
